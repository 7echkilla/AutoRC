...
DCMotor::DCMotor(int forward_pin, int backward_pin, int power_pin, float max_speed)
    : _forward_pin(forward_pin), _backward_pin(backward_pin), _power_pin(power_pin), _max_speed(max_speed) {
}

void DCMotor:: drive_motor(float value) {
    float speed = abs(value) * _max_speed;
